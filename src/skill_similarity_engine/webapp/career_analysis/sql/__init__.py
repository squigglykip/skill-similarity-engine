"""
SQL queries for Career Transition Analysis data analysis.
"""
...
class CareerAnalysisQueries:
    """Manages SQL queries for Career Transition Analysis Generator."""
...
class DatabaseReferenceCalculator:
    """Calculates specific reference values for Career Transition Analysis Generator."""
    
    def __init__(self, db_connection):
        self.db = db_connection
        self.queries = CareerAnalysisQueries()
...
query_loader = CareerAnalysisQueries()

# Export classes for import
__all__ = ['CareerAnalysisQueries', 'DatabaseReferenceCalculator', 'query_loader']
