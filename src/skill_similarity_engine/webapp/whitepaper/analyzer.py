"""
Data analysis and threshold logic for white paper generation.
"""
...
class DataAnalyzer:
    """Analyzes job transition data for white paper generation."""
    ...
    def _get_top_similar_jobs(self, job_from: str, limit: int = 3, filters: Optional[Dict] = None) -> List[Dict]:
        ...
        try:
            ...
            print(f"🔍 Filtering jobs with similarity between {similarity_min:.2f} and {similarity_max:.2f}")
