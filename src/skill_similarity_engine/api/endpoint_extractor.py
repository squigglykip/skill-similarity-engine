    ...
    def extract_skills(self):
        ...
        try:
            ...
            if len(skills) < expected_count:
                ...
                print(f"⚠️ ï¸  Retrieved {len(skills):,} of {expected_count:,} expected skills (API pagination limit)")
            ...
            print(f"⚠️ ï¸  Error extracting skills: {e}")
        ...
        for version in versions:
            ...
            try:
                ...
                if version_fields == reference_fields:
                    ...
                    print(f"  ℹ️— {version} - Incompatible (missing: {len(missing)}, extra: {len(extra)})")

                    

            except Exception as e:

                print(f"  ℹ️— {version} - Error getting metadata: {e}")
